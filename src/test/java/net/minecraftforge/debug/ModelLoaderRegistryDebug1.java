...
public class ModelLoaderRegistryDebug1
{
...
//						IFlexibleBakedModel baked = objModel.bake(state, Attributes.DEFAULT_BAKED_FORMAT, BAKED_TEXTURE_GETTER);
//						loadedModels.put("" + i, baked);
    		...
    		if (hourTens != null)
    		{
    			...
    			for (BakedQuad quad : hourTens.func_188616_a(te.getWorld().getBlockState(te.getPos()), null, 0))
    			{
    		...
    		for (BakedQuad quad : hourOnes.func_188616_a(te.getWorld().getBlockState(te.getPos()), null, 0))
    		{
    		...
    		{    			
    			...
    			for (BakedQuad quad : minsTens.func_188616_a(te.getWorld().getBlockState(te.getPos()), null, 0))
    			{
    				LightUtil.renderQuadColor(worldRenderer, quad, 0xFFFFFFFF);
    			}
    			tessellator.draw();
    		...
    		worldRenderer.begin(GL11.GL_QUADS, Attributes.DEFAULT_BAKED_FORMAT);
    		GlStateManager.translate(0.375f, 0.0f, 0.0f);
    		for (BakedQuad quad : minsOnes.func_188616_a(te.getWorld().getBlockState(te.getPos()), null, 0))
    		{
    			LightUtil.renderQuadColor(worldRenderer, quad, 0xFFFFFFFF);
    		}
    		tessellator.draw();
